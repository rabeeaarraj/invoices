...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير المدفوعة جزئياً</span>
						</div>
					</div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive hoverable-table">
                                        <a id="button" class="btn btn-primary mg-b-20" href="invoices/create" >إضافة فاتورة</a>
                                        <table id="example-delete" class="table text-md-nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="invoicedetails/{{$invoice->id}}">{{$invoice->section->section_name}}</a></td>
