    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                ...
                <p class="mg-b-0">لوحة تحكم برنامج الفواتير</p>
            </div>
        </div>
            ...
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white"> {{number_format(\App\Models\invoices::where('Value_Status',3)->sum('Total'))}}</h4>
                                <p class="mb-0 tx-12 text-white op-7">
    ...
    <div class="row row-sm">
            ...
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-0">مخطط بياني للفواتير</h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                    </div>
                    <p class="tx-12 text-muted mb-0">مدفوعة - غير مدفوعة - مدفوعة جزئياً</p>
                </div>
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                <label class="main-content-label">تمثيل بياني للفواتير</label>
                <span class="d-block mg-b-20 text-muted tx-12">مدفوعة - غير مدفوعة - مدفوعة جزئياً</span>
                <div style="width:75%;">
                    {!! $chartjs2->render() !!}
                </div>
            </div>
