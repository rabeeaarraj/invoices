...
@section('content')
    ...
    @if (session()->has('Add'))
            <div class="col-xl-12 alert alert-success alert-dismissible fade show" role="alert">
        ...
        @endif
            ...
            @if (session()->has('delete'))
                <div class="col-xl-12 alert alert-danger alert-dismissible fade show" role="alert">
                ...
                <div class="card mg-b-20">
                    ...
                    <div class="card-body">
                        <div class="table-responsive hoverable-table">
                            ...
                            <table id="example-delete" class="table text-md-nowrap" data-page-length='50'>
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>اسم المنتج</th>
